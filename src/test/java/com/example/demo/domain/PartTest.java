...
class PartTest {
    ...
    void testInventoryBelowMin() {
        ...
        isValid = partIn.getInv() >= partIn.getMinInv() && partIn.getInv() <= partIn.getMaxInv();
        assertEquals(false, isValid, "Inventory below min should be invalid.");

        partOut.setInv(1);
        partOut.setMinInv(10);
        partOut.setMaxInv(20);

        isValid = partOut.getInv() >= partOut.getMinInv() && partOut.getInv() <= partOut.getMaxInv();
        assertEquals(false, isValid, "Inventory below min should be invalid.");
    }
    ...
    void testInventoryAboveMax() {
        ...
        isValid = partIn.getInv() >= partIn.getMinInv() && partIn.getInv() <= partIn.getMaxInv();
        assertEquals(false, isValid, "Inventory above max should be invalid.");

        partOut.setInv(30);
        partOut.setMinInv(1);
        partOut.setMaxInv(25);
